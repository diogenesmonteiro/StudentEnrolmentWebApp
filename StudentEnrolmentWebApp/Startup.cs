...
namespace StudentEnrolmentWebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ICourseMembershipsService, CourseMembershipsService>();
            services.AddScoped<ICourseSubjectsService, CourseSubjectsService>();
            services.AddScoped<IStudentRepository, StudentRepository>();
            services.AddScoped<ICourseRepository, CourseRepository>();
            services.AddScoped<ISubjectRepository, SubjectRepository>();
            services.AddScoped<ICourseSubjectsRepository, CourseSubjectsRepository>();
